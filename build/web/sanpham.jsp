...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <header class="app-header">
    ...
    <ul class="app-nav">
      ...
      <!-- User Menu-->
      <li><a class="app-nav__item" href="login_register.jsp">Đăng xuất <i class='bx bx-log-out bx-rotate-180'></i> </a>
  ...
  <aside class="app-sidebar">
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="images/donelogo2.png" width="50px"
        alt="User Image">
      <div>
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item" href="http://localhost:9999/project/admin"><i
            ...
            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
              ...
              <tbody>
                <tr>
                  ...
                  <td>${p.productID}</td>
                  <td>${p.productName}</td>
                  <td><img class="img-card-person" src="${p.image}" alt=""></td>
                  <td>${p.description} </td>
                  <td>${p.quantity}</td>
                  <td>${p.productCategoryID.category_name}</td>
                  
                  <td class="table-td-center"><a  href="update?id=${p.productID}">Update</a>
                        &nbsp; &nbsp;
